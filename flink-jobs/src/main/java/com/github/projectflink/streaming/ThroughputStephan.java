...
public class ThroughputStephan {

	private static final Logger LOG = LoggerFactory.getLogger(ThroughputStephan.class);
...
//				}
	...
	public static void main(String[] args) throws Exception {
		...
		source.shuffle().flatMap(new FlatMapFunction<Type, Integer>() {
